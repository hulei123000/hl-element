import { it, describe, expect, vi, test } from 'vitest'
...
describe("Button.vue", () => {
  ...
  test("basic button", async () => {
    ...
    // class
    expect(wrapper.classes()).toContain("hl-button--primary");
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`hl-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`hl-button--${size}`);
    });
  });
